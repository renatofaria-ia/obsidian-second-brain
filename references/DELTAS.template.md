...
Why this exists: when you fork obsidian-second-brain and customize it (different bundle
...
- **Bundle path:** `<where your bundle lives>`
- **Owner / name:** `<you>`
- **Storage mode:** `<Obsidian-backed bundle | plain Markdown bundle>`
...
- [ ] Ran `scripts/bootstrap_vault.py` (or set up the bundle by hand)
...
- `<e.g. secrets live in 1Password, never in the bundle>`
